...
if [ ! -d vendor/cicada-ag/administration/Resources/app/administration/node_modules/webpack-dev-server ]; then
    npm install --prefix vendor/cicada-ag/administration/Resources/app/administration/
fi
...
npm run --prefix vendor/cicada-ag/administration/Resources/app/administration/ dev
